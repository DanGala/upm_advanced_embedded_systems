...
#define pthread_equal(a,b)	((a)==(b))
	...
	case 7: // STATE 20 - _spin_nvr.tmp:15 - [-end-] (0:0:0 - 1)
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC entorno */
	case 8: // STATE 1 - modelo_4.1.pml:24 - [button = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[1][1] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 9: // STATE 2 - modelo_4.1.pml:25 - [(!(button))] (0:0:0 - 1)
		IfNotBlocked
		reached[1][2] = 1;
		if (!( !(((int)now.button))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 10: // STATE 7 - modelo_4.1.pml:27 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[1][7] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC lampara_fsm */
	case 11: // STATE 1 - modelo_4.1.pml:7 - [state = 0] (0:0:1 - 1)
		IfNotBlocked
		reached[0][1] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 12: // STATE 2 - modelo_4.1.pml:9 - [((state==0))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][2] = 1;
		if (!((((int)now.state)==0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 13: // STATE 3 - modelo_4.1.pml:11 - [(button)] (16:0:2 - 1)
		IfNotBlocked
		reached[0][3] = 1;
		if (!(((int)now.button)))
			continue;
		...
		;
		_m = 3; goto P999; /* 4 */
	case 14: // STATE 9 - modelo_4.1.pml:14 - [((state==1))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][9] = 1;
		if (!((((int)now.state)==1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 15: // STATE 10 - modelo_4.1.pml:16 - [(button)] (16:0:2 - 1)
		IfNotBlocked
		reached[0][10] = 1;
		if (!(((int)now.button)))
			continue;
		...
		;
		_m = 3; goto P999; /* 4 */
	case 16: // STATE 19 - modelo_4.1.pml:20 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[0][19] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
