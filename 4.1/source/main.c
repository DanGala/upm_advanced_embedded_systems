...
static fsm_trans_t lights_tt[] = {
  ...
  { ENCENDIDO, button_pressed, APAGADO, switch_off },
  { -1, NULL, -1, NULL },
};
...
int main(void)
{
  ...
  /* -4- Create RTOS task and start the scheduler */
  xTaskCreate(lightsTask, "lightsTask", 70, NULL, 0, &lightsTask_Handle);
  vTaskStartScheduler();
}
